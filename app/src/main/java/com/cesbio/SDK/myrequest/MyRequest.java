...
package com.cesbio.SDK.myrequest;
...
public class MyRequest {
    ...
    public void register(final String pseudo, final String email, final String password, final String password2, final RegisterCallback callback) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, response -> {
            ...
            try {
                ...
                if (!error) {
                    callback.onSuccess(context.getString(R.string.registered_msg));
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof NetworkError) {
                    callback.onError(context.getString(R.string.network_error_msg));
                } else if (error instanceof VolleyError) {
                    callback.onError(context.getString(R.string.volley_error_msg));
                }
            }
        }) {
    ...
    public void update_password(final String password, final String password2, final int id_user, final UpdateCallback callback) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, response -> {
            ...
            try {
                ...
                Boolean error = json.getBoolean("error");
                if (!error) {
                    callback.onSuccess(context.getString(R.string.pwd_changed_msg));
    ...
    public void reset_password(final String email, final ResetCallback callback) {
        String url = URL_SERVEUR + "forgotPassword.php";
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, response -> {
            ...
            try {
                ...
                Boolean error = json.getBoolean("error");
                if (!error) {
                    callback.onSuccess(context.getString(R.string.new_pwd_msg));
    ...
    public void login(final String pseudo, final String password, final LoginCallback callback) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                if (error instanceof NetworkError) {
                    callback.onError(context.getString(R.string.network_error_msg) + " "+error.toString());
                } else if (error instanceof VolleyError) {
                    callback.onError(context.getString(R.string.volley_error_msg) + " "+error.toString());
                }
            }
        }) {
            // Envoi des paramètres que l'on veut tester dans le fichier register.php
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    Boolean error = json.getBoolean("error");
                    if (!error) {
                        callback.onSuccess(context.getString(R.string.form_sent_msg));
